...
SECRET_KEY = 'django-insecure-o6t7txyd&dea_z&y6_=b#0@t(0gz=9pf%4y+%4=tgir)$+f83h'
...
INSTALLED_APPS = [
    ...
    'Bills',"rest_framework",'corsheaders'
]
...
SESSION_COOKIE_SECURE = False  # ב-localhost
